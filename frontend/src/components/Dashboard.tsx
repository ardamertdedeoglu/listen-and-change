  ...
  const features = [
    {
      ...
      description: 'Convert spoken words in audio files into text format for easy identification and manipulation.',
      color: '#E3F2FD'
    },
    {
      icon: <EditNote sx={{ fontSize: 40, color: 'secondary.main' }} />,
      title: 'Smart Word Replacement',
      description: 'Analyze and understand context to accurately identify target words for replacement.',
      color: '#E8F5E8'
    },
    {
      icon: <VolumeUp sx={{ fontSize: 40, color: 'warning.main' }} />,
      title: 'Audio Editing',
      description: 'Professional-grade audio editing tools with word replacement and sound insertion.',
      color: '#FFF3E0'
    },
    {
      icon: <Security sx={{ fontSize: 40, color: 'error.main' }} />,
      title: 'Content Filtering',
      description: 'Advanced content filtering to create a safer internet environment for children.',
      color: '#FFEBEE'
    }
  ];
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      >
        ...
        >
          Create a family-friendly internet environment by identifying and replacing 
          inappropriate words in audio files with suitable alternatives.
        </Typography>
      ...
      >
        Powerful Features
      </Typography>      <Grid container spacing={3} sx={{ mb: 6 }}>
      ...
      <Paper elevation={1} sx={{ p: 4, borderRadius: 3, backgroundColor: 'grey.50' }}>
        <Typography 
          variant="h4" 
          component="h2" 
          align="center" 
        ...
        >
          ...
          <Grid sx={{ xs: 12, md: 3, textAlign: 'center' }}>
            <RecordVoiceOver sx={{ fontSize: 50, color: 'secondary.main', mb: 2 }} />
            <Typography variant="h6" gutterBottom sx={{ fontWeight: 600 }}>
              2. Analyze Content
            </Typography>
            <Typography variant="body2" color="text.secondary">
